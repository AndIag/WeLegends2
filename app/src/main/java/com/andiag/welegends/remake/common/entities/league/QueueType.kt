...
enum class QueueType constructor(private val ID: Long?) {
    ...
    companion object {
        ...
        private val IDs = LongSparseArray<QueueType>()

        init {
            for (t in QueueType.values()) {
                IDs.put(t.ID!!, t)
            }
        }
